(function() {
  'use strict';
  var CND, Datom, LFT, LFT_nofreeze, MAIN, Multimix, assign, badge, copy, debug, defaults, echo, help, info, isa, jr, rpr, selector_pattern, type_of, types, urge, validate, warn, whisper;
